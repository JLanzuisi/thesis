...
\section{Inmersiones $\symbf{j\colon V_{\delta+2}\embed V_{\delta+2}}$}

El siguiente resultado se sigue como una extensión de las
demostraciones del capítulo anterior.
...
\note{mencionar paper sobre esto de 2024}

\section{Consideraciones metamatemáticas}

\note
{
    Escribir discusión sobre ZFC vs NBG vs KM y establecer el marco teorico
    en el que van a desarrolarse el resto de secciones.
}
