...
la decada de 1980. La existencia de particiones de conjuntos estacionarios
...
\begin{proof}[Segunda Demostración del \cref{teo:kunen}]
	...
	Si $M=V$, entonces $j(S)(\kappa)$ es estacionario en $\lambda^+$ visto en el universo.
	La $\lambda^+$-completitud de
\end{proof}
