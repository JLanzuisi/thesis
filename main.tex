...
\begin{teo}
    ...
    $j\colon V\embed M_U\approxeq\Ult(U,V)$. Entonces,
    \begin{enumerate}[label=\alph*)]
...
\begin{proof} Veamos cada parte por separado.
    \begin{enumerate}[label=\alph*)]
        ...
        \item Sea $[f]\in M$. Si $A = \set{i\in S\mid |f(i)|\leq|S|}\in U$,
            entonces existe $\alpha\in|S|^+ - \bigcup{f(i)\mid i\in A}$ tal que
...
del texto, delimita la jerarquía de cardinales grandes de forma definitiva en ZFC.

\begin{teo}[Kunen]\label{teo:kunen}
    Si $j\colon V\embed M$, entonces $M\neq V$.
\end{teo}

\section{Demostración original del \cref{teo:kunen}}

Hace falta establecer primero un resultado, debido a Erdös-Hajnal \autocite{erdos_problem_1966},
...
\begin{proof}[Demostración del \cref{teo:kunen} \autocite{kunen_elementary_1971}]
    ...
    Además, como $\kappa$ es medible, en particular es inaccesible, y la elementaridad de $j$ implica que $j^n(\kappa)$
    ...
    Sea $s\in[j"\lambda]^\omega$. Exite entonces un $t\in[\lambda]^\omega$ tal que $j(t)=j"t=s$.
...
\section{Demostración de Hugh Woodin del \cref{teo:kunen}}
\section{Demostración de Mikio Harada del \cref{teo:kunen}}
\fi
% ------------------------------------------------------------------------------
%                                 BACKMATTER.
% ------------------------------------------------------------------------------
