...
% Actas de evaluación.
% ------------------------------------------------------------------------------
\includepdf[pages=-]{resources/actas-evaluacion.pdf}
...
% ------------------------------------------------------------------------------
\ifagradecimientos\newpage
\ChapterNoNumber{Agradecimientos}
...
Sea $C$ un conjunto y $X\subset C$, se dirá que $X$ es \concept{no acotado}
en $C$ si $\sup(X) = C$.
...
\begin{defi}\label{def:model}
    Sea $\lex{L}$ un lenguaje formal. Un \concept{modelo} $\model{A}$ para $\lex{L}$ se define como el par:
    \[
...
% TODO
% chequear redaccion primera a tercera persona
