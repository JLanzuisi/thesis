...
el concepto de inmersión elemental para clases propias, pues lo prohibe el teorema
...
\begin{proof}
    ...
    Sea $a\in M$ y $b$ la clausura transitiva de $a$ en $V$ (lo cual implica que también
    lo es en $M$). Puesto que se tiene el axioma de elección, se puede identificar
    a $b$ con un ordinal $\gamma$, sea $r$ la función testigo de este hecho.
    Se define una relación binaria $R$ en $M$ dada por:
    \[
        \op{\alpha,\beta}\in R \iff r(\alpha)\in r(\beta),
    \]
